package com.astralai.notepad.ui.theme
...
val RedOrange = Color(0xffffab92)
val RedPink = Color(0xfff48fb2)
val BabyBlue = Color(0xff81deeb)
val Violet = Color(0xffcf94db)
val LightGreen = Color(0xFFC7ED9C)
